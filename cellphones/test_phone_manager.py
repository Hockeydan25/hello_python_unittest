...
class TestPhoneManager(unittest.TestCase):
    ...
    def test_create_and_add_new_phone(self):
        ...
        # assertCountEqual checks if two lists have the same items, 
        # in any order.(Despite what the name implies)
    ...
    def test_create_and_add_new_employee(self):
        ...
        # Add some employees and verify they are present in the 
        # PhoneAssignments.employees list
        self.fail()


    def test_create_and_add_employee_with_duplicate_id(self):
        # TODO write this test and then remove the self.fail() statement
        # TODO you'll need to fix the add_employee method in 
        # PhoneAssignments to make this test PhoneAssignments
        # This method will be similar to 
        # test_create_and_add_phone_with_duplicate_id
        self.fail()
    ...
    def test_assign_phone_that_has_already_been_assigned_to_employee(self):
        # If a phone is already assigned to an employee, it is 
        # an error to assign it to a different employee. A PhoneError 
        # should be raised.
        # TODO write this test and remove the self.fail() statement
        # TODO you'll need to fix the assign method in PhoneAssignments 
        # so it throws an exception if the phone is alreaady assigned.
    ...
    def test_assign_phone_to_employee_who_already_has_a_phone(self):
        # TODO write this test and remove the self.fail() statement
        # TODO you'll need to fix the assign method in 
        # PhoneAssignments so it raises a PhoneError if the phone 
    ...
    def test_assign_phone_to_the_employee_who_already_has_this_phone(self):
        # TODO The method should not make any changes but NOT raise 
        # a PhoneError if a phone
    ...
    def test_get_phone_info_for_employee(self):
        ...
        # TODO check that the method returns None if the employee does 
        # not have a phone
        # TODO check that the method raises an PhoneError if the 
